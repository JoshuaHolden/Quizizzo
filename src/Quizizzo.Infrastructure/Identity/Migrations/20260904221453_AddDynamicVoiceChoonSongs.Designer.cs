...
namespace Quizizzo.Infrastructure.Identity.Migrations
{
    ...
    [Migration("20260904221453_AddDynamicVoiceChoonSongs")]
    partial class AddDynamicVoiceChoonSongs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quizizzo.Domain.Voice.VoiceChoonSong", b =>
                {
                    ...
                    b.ToTable("VoiceChoonSongs", (string)null);
                });

            modelBuilder.Entity("Quizizzo.Domain.Voice.VoiceSampleMetadata", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SubmissionId", "GameInstanceId", "PlayerId", "PromptKey")
                        .IsUnique();

                    b.ToTable("VoiceSamples", (string)null);
                });
            ...
            modelBuilder.Entity("Quizizzo.Domain.Players.Player", b =>
                {
                    ...
                    b.OwnsOne("Quizizzo.Domain.Players.CharacterDefinition", "Character", b1 =>
                        {
                            ...
                            b1.Property<int>("EyeColour")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterEyeColour");

                            b1.Property<int>("EyeSize")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterEyeSize");

                            b1.Property<int>("Eyes")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterEyes");

                            b1.Property<int>("FaceShape")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterFaceShape");

                            b1.Property<int>("HairColour")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterHairColour");

                            b1.Property<int>("HairStyle")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterHairStyle");

                            b1.Property<int>("Mouth")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterMouth");

                            b1.Property<int>("NoseShape")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterNoseShape");
                            ...
                            b1.Property<int>("ShirtStyle")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterShirtStyle");

                            b1.Property<int>("ShoeColour")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterShoeColour");

                            b1.Property<int>("ShoeStyle")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterShoeStyle");
                            ...
                            b1.Property<int>("TrouserStyle")
                                .HasColumnType("integer")
                                .HasColumnName("CharacterTrouserStyle");
                    ...
                    b.OwnsMany("Quizizzo.Domain.Players.PlayerGameWin", "GameWins", b1 =>
                        {
                            b1.Property<Guid>("PlayerId")
                                .HasColumnType("uuid");

                            b1.Property<Guid>("GameInstanceId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<DateTimeOffset>("WonAt")
                                .HasColumnType("timestamp with time zone");

                            b1.HasKey("PlayerId", "GameInstanceId");

                            b1.HasIndex("GameKey");

                            b1.HasIndex("WonAt");

                            b1.ToTable("PlayerGameWins", (string)null);
